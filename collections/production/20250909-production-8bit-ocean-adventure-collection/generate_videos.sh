#!/bin/bash
# 8-Bit Ocean Adventure Collection - 完全動画生成スクリプト v7.0
...
BASE_DIR="$SCRIPT_DIR"
INPUT_MAIN="$BASE_DIR/10-assets/main-8bit-ocean.png"
...
echo "🌊 8-Bit Ocean Adventure Collection - 動画生成開始 🌊"
...
echo "📁 ファイル存在確認中..."
check_file "$INPUT_MAIN" "main-8bit-ocean.png" || exit 1
...
MASTER_OUTPUT="$BASE_DIR/01-master/8-Bit-Ocean-Adventure-Collection-Master.mp4"
...
echo ""
echo "🎉 8-Bit Ocean Adventure Collection 動画生成完了！ 🌊"
echo "📊 結果サマリー:"
echo "   📹 マスター動画: 1本生成完了"
